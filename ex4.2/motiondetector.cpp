...
// a ideia é comparar o histograma antigo azul com um novo, mas me enrolei

    if(firstHist){
        
        double base_base = compareHist(oldHist, histB, 1);

        std::cout << "OLHA AQUI: " << base_base << std::endl;
